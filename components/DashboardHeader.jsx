...
const DashboardHeader = ({ user }) => {
  return (
    <div className="h-20 w-full top-0 text-sky-100 gap-20 fixed text-xl flex justify-between items-center rounded-b-4xl py-3 px-20 transition-all duration-400 ease-in-out border-amber-50 border-b-2">
