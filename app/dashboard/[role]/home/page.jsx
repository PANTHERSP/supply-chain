      ...
      {/* <div className=" text-sky-100 h-full w-full"> */}
        ...
        {/* <div className="flex flex-col justify-center relative top-0 left-0 w-full h-full"> */}
          <div className='gap-8 flex flex-col max-w-[620px] z-10 my-auto self-start'>
            ...
            <Link href={`/dashboard/${user.role}/explorer`} className='w-25 text-lg font-semibold flex justify-center items-center p-3 bg-gradient-to-r from-blue-600/80 via-indigo-400/80 to-purple-500/80 rounded-2xl cursor-pointer'>
              Explore
            </Link>
          </div>
